...
import net.azagwen.atbyw.EntityTypeRegistry;
import net.azagwen.atbyw.Tags;
...
public class ShroomStickEntity extends ThrownItemEntity {
    ...
    public ShroomStickEntity(World world, LivingEntity owner) {
        super(EntityTypeRegistry.SHROOMSTICK, owner, world);
    }

    public ShroomStickEntity(World world, double x, double y, double z) {
        super(EntityTypeRegistry.SHROOMSTICK, x, y, z, world);
    }

    protected Item getDefaultItem() {
        return ItemRegistry.SHROOMSTICK;
    }
    ...
    private void spawnItem(World world, BlockPos pos) {
        ...
        var stack = ItemRegistry.SHROOMSTICK.getDefaultStack();
    ...
    private void placeBlock(World world, BlockPos hitPos, boolean waterLogged) {
        ...
        world.setBlockState(hitPos, BlockRegistry.SHROOMSTICK.getDefaultState().with(ShroomStickBlock.WATERLOGGED, waterLogged));
        this.remove(RemovalReason.KILLED);
    }
