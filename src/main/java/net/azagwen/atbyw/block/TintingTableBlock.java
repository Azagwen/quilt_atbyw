...
public class TintingTableBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, BlockEntityTypeRegistry.TINTING_TABLE_BLOCK_ENTITY, TintingTableBlockEntity::tick);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            ...
            if (blockEntity instanceof TintingTableBlockEntity) {
                ...
                player.incrementStat(StatsRegistry.INTERACT_WITH_TINTING_TABLE);
            }
