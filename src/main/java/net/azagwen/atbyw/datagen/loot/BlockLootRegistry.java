...
public class BlockLootRegistry {
    ...
    private static void registerDropsSilkTouchAlternatives() {
        ...
        blocks.put(BuildingBlockRegistry.SHATTERED_GLASS, ItemRegistry.GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.WHITE_STAINED_SHATTERED_GLASS, ItemRegistry.WHITE_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.ORANGE_STAINED_SHATTERED_GLASS, ItemRegistry.ORANGE_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.MAGENTA_STAINED_SHATTERED_GLASS, ItemRegistry.MAGENTA_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.LIGHT_BLUE_STAINED_SHATTERED_GLASS, ItemRegistry.LIGHT_BLUE_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.YELLOW_STAINED_SHATTERED_GLASS, ItemRegistry.YELLOW_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.LIME_STAINED_SHATTERED_GLASS, ItemRegistry.LIME_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.PINK_STAINED_SHATTERED_GLASS, ItemRegistry.PINK_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.GRAY_STAINED_SHATTERED_GLASS, ItemRegistry.GRAY_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.LIGHT_GRAY_STAINED_SHATTERED_GLASS, ItemRegistry.LIGHT_GRAY_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.CYAN_STAINED_SHATTERED_GLASS, ItemRegistry.CYAN_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.PURPLE_STAINED_SHATTERED_GLASS, ItemRegistry.PURPLE_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.BLUE_STAINED_SHATTERED_GLASS, ItemRegistry.BLUE_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.BROWN_STAINED_SHATTERED_GLASS, ItemRegistry.BROWN_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.GREEN_STAINED_SHATTERED_GLASS, ItemRegistry.GREEN_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.RED_STAINED_SHATTERED_GLASS, ItemRegistry.RED_STAINED_GLASS_SHARD, 4);
        blocks.put(BuildingBlockRegistry.BLACK_STAINED_SHATTERED_GLASS, ItemRegistry.BLACK_STAINED_GLASS_SHARD, 4);
