...
public class RecipeRegistry {
    ...
    public static Recipe<?> SHULKER_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("shulker_essence"), "essence", Lists.newArrayList(Items.SHULKER_SHELL, Items.SHULKER_SHELL, Items.GLASS_BOTTLE), ItemRegistry.SHULKER_ESSENCE, 1);
    public static Recipe<?> CHICKEN_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("chicken_essence"), "essence", Lists.newArrayList(Items.CHICKEN, Items.FEATHER, Items.GLASS_BOTTLE), ItemRegistry.CHICKEN_ESSENCE, 1);
    public static Recipe<?> RABBIT_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("rabbit_essence"), "essence", Lists.newArrayList(Items.RABBIT, Items.RABBIT_HIDE, Items.GLASS_BOTTLE), ItemRegistry.RABBIT_ESSENCE, 1);
    public static Recipe<?> COD_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("cod_essence"), "essence", Lists.newArrayList(Items.COD, Items.BONE_MEAL, Items.GLASS_BOTTLE), ItemRegistry.COD_ESSENCE, 1);
    public static Recipe<?> SALMON_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("salmon_essence"), "essence", Lists.newArrayList(Items.SALMON, Items.BONE_MEAL, Items.GLASS_BOTTLE), ItemRegistry.SALMON_ESSENCE, 1);
    public static Recipe<?> PUFFER_FISH_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("puffer_fish_essence"), "essence", Lists.newArrayList(Items.PUFFERFISH, Items.BONE_MEAL, Items.GLASS_BOTTLE), ItemRegistry.PUFFER_FISH_ESSENCE, 1);
    public static Recipe<?> SLIME_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("slime_essence"), "essence", Lists.newArrayList(Items.SLIME_BALL, Items.GLASS_BOTTLE), ItemRegistry.SLIME_ESSENCE, 1);
    public static Recipe<?> MAGMA_CUBE_ESSENCE = RecipeDatagen.shapelessRecipe(AtbywMain.id("magma_cube_essence"), "essence", Lists.newArrayList(Items.MAGMA_CREAM, Items.GLASS_BOTTLE), ItemRegistry.MAGMA_CUBE_ESSENCE, 1);

    public static Recipe<?> SHULKER_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("shulker_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.SHULKER_ESSENCE), StatueRegistry.SHULKER_STATUE, 1);
    public static Recipe<?> CHICKEN_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("chicken_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.CHICKEN_ESSENCE), StatueRegistry.CHICKEN_STATUE, 1);
    public static Recipe<?> RABBIT_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("rabbit_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.RABBIT_ESSENCE), StatueRegistry.RABBIT_STATUE, 1);
    public static Recipe<?> COD_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("cod_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.COD_ESSENCE), StatueRegistry.COD_STATUE, 1);
    public static Recipe<?> SALMON_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("salmon_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.SALMON_ESSENCE), StatueRegistry.SALMON_STATUE, 1);
    public static Recipe<?> PUFFER_FISH_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("puffer_fish_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.PUFFER_FISH_ESSENCE), StatueRegistry.PUFFER_FISH_STATUE, 1);
    public static Recipe<?> SLIME_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("slime_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.SLIME_ESSENCE), StatueRegistry.SLIME_STATUE, 1);
    public static Recipe<?> MAGMA_CUBE_STATUE = RecipeDatagen.shapelessRecipe(AtbywMain.id("magma_cube_statue"), "statues", Lists.newArrayList(Blocks.STONE, ItemRegistry.MAGMA_CUBE_ESSENCE), StatueRegistry.MAGMA_CUBE_STATUE, 1);
    ...
    private static void registerBricksPatterns() {
        ...
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.SHATTERED_GLASS, glassCount), ItemRegistry.GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.WHITE_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.WHITE_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.ORANGE_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.ORANGE_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.MAGENTA_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.MAGENTA_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.LIGHT_BLUE_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.LIGHT_BLUE_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.YELLOW_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.YELLOW_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.LIME_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.LIME_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.PINK_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.PINK_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.GRAY_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.GRAY_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.LIGHT_GRAY_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.LIGHT_GRAY_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.CYAN_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.CYAN_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.PURPLE_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.PURPLE_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.BLUE_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.BLUE_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.BROWN_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.BROWN_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.GREEN_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.GREEN_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.RED_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.RED_STAINED_GLASS_SHARD);
        map.put(new RecipeData("shattered_glass", "shattered_glass", BuildingBlockRegistry.BLACK_STAINED_SHATTERED_GLASS, glassCount), ItemRegistry.BLACK_STAINED_GLASS_SHARD);
    ...
    private static void registerColumnPatterns() {
        ...
        map.put(new RecipeData(DecorationBlockRegistry.LARGE_CHAIN, 1), ItemRegistry.LARGE_CHAIN_LINK);
    ...
    private static void registerStickPatterns() {
        ...
        map.put(new RecipeData(ItemRegistry.BAMBOO_STICK, 4), Items.BAMBOO);
        map.put(new RecipeData(ItemRegistry.SHROOMSTICK, 4), Blocks.SHROOMLIGHT);
    ...
    private static void registerSpikeTraps() {
        ...
        for (var entry : map.entrySet()) {
            ...
            keys.put('S', Ingredient.ofTag(ItemTags.STONE_CRAFTING_MATERIALS));
    ...
    private static void registerBookshelfToggles() {
        ...
        for (var entry : map.entrySet()) {
            ...
            keys.put('C', Ingredient.ofTag(ItemTags.STONE_CRAFTING_MATERIALS));
    ...
    private static void registerLadderPatterns() {
        ...
        keys.put('S', Ingredient.ofItems(ItemRegistry.BAMBOO_STICK));
    ...
    private static void registerMisc() {
        ...
        keys.put('P', Ingredient.ofTag(ItemTags.PLANKS));
        ...
        recipeData = new RecipeData(ItemRegistry.LARGE_CHAIN_LINK, 2);
        registerShapedRecipe(recipeData, pattern.getFirst(), pattern.getSecond());
